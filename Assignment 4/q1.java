// Approach:
// We traverse from initial cell and check if same char is present in up or left cell if yes then this cell have to be
// changed. Otherwise we check for its down and right cell if it matches with them then we have 2 options either we
// change this cell value or continue so that later on the right/down matche cell value can be changes
